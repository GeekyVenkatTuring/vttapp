...
export function AudioRecorder({ onTranscriptionComplete, onStreamChange, onProcessingChange, language }: Props) {
      ...
      <div className="flex gap-4">
        {!isRecording && !isProcessing && (
          <button
            ...
            className="flex items-center gap-2 rounded-full bg-green-600 px-6 py-3 font-semibold text-white transition-colors hover:bg-green-500"
          >
