...
_SYSTEM_PROMPT = (
    ...
    "- Prefer several SHORT sentences over one long run-on. Split where the "
    "speaker clearly starts a new thought.\n"
    "- Start a new paragraph when the topic clearly shifts.\n"
    "- Drop only pure filler: 'um', 'uh', 'you know', 'like', 'basically', and a "
    "redundant 'so'/'and'/'and then' at the START of a thought. Do not remove or "
    "swap meaningful connectives.\n"
    ...
    "Hard limits:\n"
    "- NEVER add facts, opinions, answers, or commentary. NEVER change the meaning, "
    "the verb tense, or a connective (do NOT turn 'but'/'and' into 'so', etc.). "
    "Keep every meaningful word and keep each sentence grammatically complete — "
    "never drop the subject. You may only split sentences, add paragraph breaks, "
    "and remove pure filler.\n"
...
_FEWSHOT = (
    ...
    "Input: <<<so i woke up late today and then i rushed to the meeting and i "
    "forgot my laptop so i had to go back home and get it then i finally reached "
    "the office>>>\n"
    "Output: I woke up late today and rushed to the meeting. I forgot my laptop, "
    "so I had to go back home and get it. I finally reached the office.\n\n"
    "Input: <<<{text}>>>\n"
    "Output:"
)
